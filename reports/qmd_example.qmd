...
![Horse populations for all provinces in Canada from 1906 - 1972](../results/horse_pops_plot.png){width=70% #fig-1}
...
We present the standard deviations in @tbl-prov.
...
Additionally, note that in @tbl-prov we consider the sample standard deviation of the number of horses during the same time span as @fig-1.

![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){width=50% #fig-2}
